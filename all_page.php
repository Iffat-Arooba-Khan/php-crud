  ...
  <body>
	...
	<div class="container">
		...
		<table class="table">
			...
			?>
				<tr>
					<td><?php echo $row['pages_id'] ; ?></td>
					<td><?php echo $row['pages_title'] ; ?></td>
					<td><?php echo $row['pages_des'] ; ?></td>
					<td>
					<a href="edit.php?pages_id=<?php echo $row['pages_id'] ; ?>" class="btn btn-dark">Edit</a>
						<a href="delete.php?pages_id=<?php echo $row['pages_id'] ; ?>" class="btn btn-danger">Delete</a>
						</td>
				</tr>
			<?php		
					}
