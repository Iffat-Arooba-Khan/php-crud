...
$edit = "SELECT * FROM pages WHERE pages_id = $id";
...
if(isset($_POST['update'])){
	...
	$update = "UPDATE pages SET pages_title = '$pagetitle', pages_des = '$pagedes' WHERE pages_id = $id";
	...
	<div class="container">
	  ...
	  <form method="post" action="">
		  ...
		  <div class="form-group">
			...
			<textarea class="form-control" name="pagecontent" id="exampleFormControlTextarea1" rows="3"><?php echo $row['page_des'] ; ?></textarea>
		  </div>
		  <div class="form-group">
